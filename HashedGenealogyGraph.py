...
class HGG:
    ...
    def addEdge(self, obj, n1, ln1, id1, n2, ln2, id2, children):
        ...
        children_array = (TupleStrInt * len(children))(*[TupleStrInt(*child) for child in children])
        return self.lib.addEdge(obj, self.create_char_p(n1), self.create_char_p(ln1), id1,
                                self.create_char_p(n2), self.create_char_p(ln2), id2, children_array, len(children))
